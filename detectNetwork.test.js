  ...
  for (var len = 12; len <= 19; len++) {
    (function(len) {
      it('has a prefix of 5018 and a length of ' + len, function() {
        detectNetwork('5018' + '567890123456789'.slice(0,len-4)).should.equal('Maestro');
      });

      it('has a prefix of 5020 and a length of ' + len, function() {
        detectNetwork('5020' + '567890123456789'.slice(0,len-4)).should.equal('Maestro');
      });

      it('has a prefix of 5038 and a length of ' + len, function() {
        detectNetwork('5038' + '567890123456789'.slice(0,len-4)).should.equal('Maestro');
      });

      it('has a prefix of 6304 and a length of ' + len, function() {
        detectNetwork('6304' + '567890123456789'.slice(0,len-4)).should.equal('Maestro');
      });
    })(len)
  }
});
      ...
      for (var len = 16; len <= 19; len++) {
        (function(len) {
          it('has a prefix of ' + prefix + ' and a length of ' + len, function() {
            detectNetwork(prefix + '7890123456789'.slice(0,len-6)).should.equal('China UnionPay');
          });
        })(len)
      }
    })(prefix)
  ...
  for (var prefix = 624; prefix <= 626; prefix++) {
    (function(prefix) {
      for (var len = 16; len <= 19; len++) {
        (function(len) {
          it('has a prefix of ' + prefix + ' and a length of ' + len, function() {
            detectNetwork(prefix + '4567890123456789'.slice(0,len-3)).should.equal('China UnionPay');
          });
        })(len)
      }
    })(prefix)
  ...
  for (var prefix = 6282; prefix <= 6288; prefix++) {
    (function(prefix) {
      for (var len = 16; len <= 19; len++) {
        (function(len) {
          it('has a prefix of ' + prefix + ' and a length of ' + len, function() {
            detectNetwork(prefix + '567890123456789'.slice(0,len-4)).should.equal('China UnionPay');
          });
        })(len)
      }
    })(prefix)
...
describe('should support Switch', function() {
  ...
  for (var i = 0; i < prefix.length; i++) {
    (function(prefix, i) {
      it('has a prefix of ' + prefix[i] + ' and a length of 16', function() {
        detectNetwork(prefix[i] + '567890123456').should.equal('Switch');
      });

      it('has a prefix of ' + prefix[i] + ' and a length of 18', function() {
        detectNetwork(prefix[i] + '56789012345678').should.equal('Switch');
      });

      it('has a prefix of ' + prefix[i] + ' and a length of 19', function() {
        detectNetwork(prefix[i] + '567890123456789').should.equal('Switch');
      });
    })(prefix, i)
  }
  ...
  for (var i = 0; i < prefix.length; i++) {
    (function(i) {
      it('has a prefix of ' + prefix[i] + ' and a length of 16', function() {
        detectNetwork(prefix[i] + '7890123456').should.equal('Switch');
      });

      it('has a prefix of ' + prefix[i] + ' and a length of 18', function() {
        detectNetwork(prefix[i] + '789012345678').should.equal('Switch');
      });

      it('has a prefix of ' + prefix[i] + ' and a length of 19', function() {
        detectNetwork(prefix[i] + '7890123456789').should.equal('Switch');
      });
    })(i)
  }
});
